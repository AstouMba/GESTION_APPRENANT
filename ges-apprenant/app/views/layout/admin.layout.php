...
<head>
    <meta charset="UTF-8">
    <meta éa
    naaame="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <div class="app-container">
        ...
        <div class="sidebar">
            <div class="logo-container">
                ...
                <!-- filepath: /var/www/ges-apprenant_12/ges-apprenant/app/views/admin.layout.php -->
    <div class="active-promotion">
        <?php if (!empty($current_promotion)): ?>
            <ul>
                <li>
                    <strong><?= htmlspecialchars($current_promotion['name']) ?></strong>
                </li>
            </ul>
        <?php else: ?>
